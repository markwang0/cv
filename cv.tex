...
\section{Research Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Support 23 fellows researching flood prediction at the National Water Center}
				\resumeItem{Compile and edit final report documenting six group projects}
				\resumeItem{Plan institute's seven week timeline with faculty theme leaders}
      \resumeItemListEnd 
			\begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
